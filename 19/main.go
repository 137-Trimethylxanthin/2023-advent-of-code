...
func main() {
    input := readFileToString("INPUTTTTTTTTTTTTTTT.txt")

    fmt.Println("Running on input.txt.")

    start := time.Now()
    fmt.Println("Part 1 Result:", part1(strings.TrimSpace(input)))
    fmt.Println("Part 2 Result:", part2(strings.TrimSpace(input)))
